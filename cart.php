...
<head>
    ...
    <title>Stlyle Studio | Online Shopping Site for Men</title>
...
while ($row = mysqli_fetch_array($result)) {
    ...
    $id = rtrim($id, ", ");
    echo "<tr><td></td><td>Total</td><td>Rs " . $sum . "</td><td><a href='success.php' class='btn btn-warning btn-lg'>Confirm Order</a></td></tr>";
    ?>
                            </tbody>
                            <?php
} else {
